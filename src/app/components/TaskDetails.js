...
function TaskTabs({ task }) {
  ...
  const tabs = [
    { id: "attachment", label: "Attachment", icon: "/Iconf.png" },
    { id: "subtask", label: "Sub Task", icon: "/Iconf.png" },
    { id: "comment", label: "Comment", icon: "/Iconf.png" },
  ];
            ...
            >
              ...
              {thingy && (
                <div className="absolute text-[10px] sm:text-xs top-4 right-4 min-w-20 bg-white border border-gray-300 rounded-md flex flex-col p-1 divide-y divide-gray-300">
                  ...
                  <button className="p-1 hover:bg-gray-100">Fly away</button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] xl:grid-cols-[3fr_1.5fr]">
          <div className="p-3 sm:p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
            ...
            {/* <div className="border rounded-lg">
              <div className="flex justify-around text-xs gap-4 p-1 border-b bg-[#F9FAFB]">
                <button className="flex items-center gap-2 px-4 py-2 text-gray-600">
                  <img src="/Iconf.png" alt="" className="w-4 h-4" />
                  Attachment
                </button>
                <button className="flex items-center gap-2 px-4 py-2 text-gray-600">
                  <img src="/Iconf.png" alt="" className="w-4 h-4" />
              ...
              <div className="flex flex-col gap-2 text-xs text-gray-600 p-2"></div>
            </div> */}
            <TaskTabs task={task} />
          </div>
          ...
          <div className="flex">
            ...
            {/* <div className="flex justify-between items-center min-w-[200px] p-2">
              <h3 className="text-[#145389] font-medium">Activity</h3>
              <div className="flex gap-2 items-center">
                <img src="/Icong.png" alt="" />
                <img src="/filter-lines.png" alt="" />
              </div>
            </div> */}
